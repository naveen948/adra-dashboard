...
export default function Dashboard(){
    return <div className="px-3 mt-1 scroll ">
    <div className="row">
        <div className="col-12 col-xl-5">
            <div className="row mt-2">
                <div className="col-md-6 col-12 pe-xl-0 ">
              ...
              <div className="attend-icon-holder ">
                ...
                <p className=" mb-1 sub-head-text-1 dash-card-text">Total Employees</p>
          </div></div>
                <div className="col-md-6  pe-xl-0 col-12 "><div className="card  card-effect shadow rounded card-cursor  p-3 mb-3">
                <div className="d-flex justify-content-between ">
              ...
              <div className="attend-icon-holder">
                ...
                <p className="mb-1 sub-head-text-1 dash-card-text">Absent</p>
          </div></div>
            </div>
            <div className="row">
                <div className="col-md-6  col-12  pe-xl-0 "><div className="card card-effect shadow rounded card-cursor  p-3 mb-3">
                <div className="d-flex justify-content-between ">
              ...
              <div className="attend-icon-holder">
                ...
                <p className=" mb-1 sub-head-text-1 dash-card-text">Company Expenses</p>
          </div></div>
                <div className="col-md-6  pe-xl-0 col-12 "><div className="card card-effect shadow rounded card-cursor  p-3 mb-3">
                <div className="d-flex justify-content-between ">
              <p className="fw-medium">₹ 2,00,000</p>
              <div className="attend-icon-holder">
                ...
                <p className=" mb-1 sub-head-text-1 dash-card-text">Expenses</p>
          </div></div>
            </div>
        </div>
            <div className="col-xl-4  pe-xl-0 col-12 col-md-6 my-2 mb-3">
                <div className="card   shadow h-100   ">
                    <div className="d-flex mt-3  justify-content-between">
                    <p className="dash-head mt-0 ">Attendence</p>
                    <input type="month" className="form-control sub-head-text-4  dash-date mt-0  w-50" />
                    </div>
                    ...
                    <div className=" p-2  list-card">
                        ...
                        <div className="d-flex">
                            ...
                            <div className="ms-2 mt-1">
                                ...
                                <p className="m-0 sub-head-text-4 text-primary">Renewal Date : Aug 15, 2025</p>
                            </div>
                        </div>
                        <div className="pt-2">
    ...
    <div className="row table-flow">
        <div className="col-lg-8 col-12 col-md-7 mb-3 mb-md-0   pe-lg-0 top-payroll-margin">
          <div className="card shadow card-cursor h-100   bg-white height-1">
            <div className="p-2 d-flex justify-content-between ">
              <div className="payroll-heading">
                <p className="m-0 text-color sub-head-text-1 ">All Acivites</p>
                <p className="text-start sub-text fw-medium">Payroll Expenses</p>
              </div>
              <div className="mt-3 me-md-1 me-0">
                <input type="date" className="form-control payroll-input sub-head-text-2 ms-2 ms-md-0" />
              </div>
            </div>
            <div style={{overflow:"scroll"}}  className=" px-3 dash-bar  pb-0" >
        ...
        <div className="col-lg-4 col-md-5 col-12">
          <div className="card shadow  card-cursor  bg-white h-100">
            <div>
              <p className="payroll-heading text-start dash-head fw-semibold ms-1 mt-3 mb-1">Employment Status</p>
            </div>
            <div className="card-body ">
              ...
              <div className="mt-xl-4  pt-2 employment-status-img">
          ...
          <div className="d-lg-flex  justify-content-between">
            <div className="col-lg-7 ">
              <div className="attend-graph-header  ">
                <p className="table-heading-1 fw-medium   sub-text">Employees</p>
            ...
            >
              ...
              />
              <input type="date" className="form-control w-25 button-size-head sub-head-text-2   " />
            </div>
          </div>
          <div className="table-flow m-3"  >
            <table className="table border ms-2  table-vertical-lines table-hover ">
              <thead className="sub-head-text-1">
                <tr className="text-center table-success">
                  <td  className="p-2 ">Sno</td>
                  <td>Employee</td>
                  <td>Role</td>
                  <td className="width-depart">Department</td>
                  <td>Date</td>
                  <td>Status</td>
                  <td>Check-In</td>
                  <td>Check-Out</td>
